...
treated_units<-c(5949)#c(5108, 4631, 6473, 4528)#ここを変更する。
...
#日付を格納
start_day<-as.Date('2021-10-22')
end_day<-as.Date('2022-01-21')
start_estimation_window<-as.Date('2021-11-16')
end_estimation_window<-as.Date('2021-12-03')
event_day<-as.Date('2021-12-06')#本当は20221211
start_post_event_window<-as.Date('2021-12-06')
end_post_event_window<-as.Date('2022-01-21')
#date_numericを列に追加。
