...
treated_units<-c(6366)#c(5108, 4631, 6473, 4528)#ここを変更する。
...
#日付を格納
start_day<-as.Date('2019/1/21')
end_day<-as.Date('2019/4/19')
start_estimation_window<-as.Date('2019/2/13')
end_estimation_window<-as.Date('2019/3/1')
event_day<-as.Date('2019/3/4')#本当は20221211
start_post_event_window<-as.Date('2019/3/4')
end_post_event_window<-as.Date('2019/4/19')
#date_numericを列に追加。
