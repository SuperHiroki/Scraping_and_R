...
treated_units<-c(6506)#c(5108, 4631, 6473, 4528)#ここを変更する。
...
#日付を格納
start_day<-as.Date('2019/4/25')
end_day<-as.Date('2019/7/26')
start_estimation_window<-as.Date('2019/5/22')
end_estimation_window<-as.Date('2019/6/7')
event_day<-as.Date('2019/6/10')#本当は20221211
start_post_event_window<-as.Date('2019/6/10')
end_post_event_window<-as.Date('2019/7/26')
#date_numericを列に追加。
