...
treated_units<-c(5401, 6098)#c(5108, 4631, 6473, 4528)#ここを変更する。
...
#日付を格納
start_day<-as.Date('2018/7/30')
end_day<-as.Date('2018/10/24')
start_estimation_window<-as.Date('2018/8/22')
end_estimation_window<-as.Date('2018/9/7')
event_day<-as.Date('2018/9/10')#本当は20221211
start_post_event_window<-as.Date('2018/9/10')
end_post_event_window<-as.Date('2018/10/24')
#date_numericを列に追加。
