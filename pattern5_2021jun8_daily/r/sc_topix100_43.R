...
treated_units<-c(7269)#c(5108, 4631, 6473, 4528)#ここを変更する。
...
#日付を格納
start_day<-as.Date('2021-04-23')
end_day<-as.Date('2021-07-21')
start_estimation_window<-as.Date('2021-05-19')
end_estimation_window<-as.Date('2021-06-04')
event_day<-as.Date('2021-06-07')#本当は20221211
start_post_event_window<-as.Date('2021-06-07')
end_post_event_window<-as.Date('2021-07-21')
#date_numericを列に追加。
